...
if($lingua!=''){
	if($lingua='BG'){
    header('location:dunavsko-horo-cello_bg.php');
	  exit;
    }
}
?>
...
<head>
    <title>Danza popolare bulgara - Dunavsko Horo - cello cover  </title>
	<meta name="description" content="Note e video del Dunavsko Horo fatto per violoncello. Suonato e arrangiato da Veronika Krasteva. File pdf con le note scaricabile senza pagamento.">
    <meta charset="utf-8">
 ...
 <?php include 'menu.php';?>
    ...
    Language	  
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="dunavsko-horo-cello.php?lingua=BG"> <span class="flag-icon flag-icon-bg"></span>Български</a>
		...
		<div class="header">
            <div class="row row2">
                <div class="col-md-12">
                    <h1>Dunavsko Horo - Cello Cover </h1>
                </div>   
</div>				
            <div class="row row2">     			
			...
			<h4> Cover per violoncello della danza popolare bulgara Dunavsko Horo. Suonata e arrangiata da me. <h4>
			</div>
			</div>
			<div class="row row4">
