...
if($lingua!=''){
	if($lingua='BG'){
    header('location:kansas-dust-in-the-wind-flute-guitar-cello_bg.php');
	  exit;
    }
}
?>
...
<head>
    <title>Kansas "Dust in the Wind" cover per flauto, violoncello e chitarra</title>
	<meta name="description" content="Note e video dalla canzone Dust in the Wind di Kansas fatta per flauto, violoncello e chitarra. Suonata e arrangiata da Veroika Krasteva. File pdf con le note scaricabile senza pagamento.">
    <meta charset="utf-8">
 ...
 <?php include 'menu.php';?>
    ...
    Language	  
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="kansas-dust-in-the-wind-flute-guitar-cello.php?lingua=BG"> <span class="flag-icon flag-icon-bg"></span>Български</a>
		...
		<div class="header">
            <div class="row row2">
                <div class="col-md-12">
                    <h1>Kansas "Dust in the Wind" cover per flauto, violoncello e chitarra</h1>
                </div>   
</div>				
            <div class="row row2">     			
			...
			<h4> Cover della canzone famosa di Kansas - Dust in the Wind per flauto, violoncello e chitarra. Suonata (la parte di violoncello) e arrangiata da me. Con la colaborazione di Jennifer Claudina (flauto) e Zaira Fortunato (chitarra).<h4>
			</div>
			</div>
			<div class="row row4">
			<div class="col-md-8 col-xs-12">			
		    <h5>Se ti piace questo pezzo visita il mio <b>canale youtube</b> dove troverai tanti altri belli cose. </h5>  
			</div>			
			...
			<div class="row row4">
			<div class="col-md-8 col-xs-12">	
			<h5>Se hai una <b>richiesta</b> di che pezzo voi sentire prossimamente scrivimmi</h5>
			</div>
			<div class="col-md-4 col-xs-12">			
...
<div class="row">	
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">Strumenti</th>
      <td colspan="2">flauto, violoncello e chitarra</td>
    </tr>
	<tr>
	...
	<tr>
      ...
      <td colspan="2">Si</td>
		...
		<tr>
      <th scope="row">Pdf scaricabile</th>
      <td colspan="2">Si (senza la parte della chitarra)</td>
    </tr>
  </tbody>
</table>
</div>
