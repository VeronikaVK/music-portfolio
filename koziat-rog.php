...
if($lingua!=''){
	if($lingua='BG'){
    header('location:koziat-rog_bg.php');
	  exit;
    }
}
?>
...
<head>
    <title>Maria Neikova "Varviat li dvama" (Koziat Rog) - violoncello</title>
	<meta name="description" content="Note e video della canzone di Maria Neikova  “Varviat li dvama” (Koziat Rog). Suonato e arrangiato da Veroika Krasteva. File pdf con le note scaricabile senza pagamento.">
    <meta charset="utf-8">
 ...
 <?php include 'menu.php';?>
    ...
    Language	  
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="koziat-rog.php?lingua=BG"> <span class="flag-icon flag-icon-bg"></span>Български</a>
		...
		<div class="header">
            <div class="row row2">
                <div class="col-md-12">
                    <h1> Maria Neikova "Varviat li dvama" (Koziat Rog/The Goat horn) - Cover per violoncello</h1>
                </div>   
</div>				
            <div class="row row2">     			
			...
			<h4> Cover per violoncello della canzone “Varviat li dvama”  del famoso film bulgaro Koziqt Rog. Suonata e arrangiata da me. <h4>
			</div>
			</div>
			<div class="row row4">
...
<div class="row">	
  ...
  <tbody>
	...
	<tr>
      ...
      <td>Koziqt Rog (The Goat horn)</td>
    </tr>
    <tr>
      <th scope="row">Strumenti</th>
      <td colspan="2">violoncello</td>
    </tr>
	<tr>
