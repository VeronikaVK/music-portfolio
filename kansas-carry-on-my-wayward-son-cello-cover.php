...
if($lingua!=''){
	if($lingua='BG'){
    header('location:kansas-carry-on-my-wayward-son-cello-cover_bg.php');
	  exit;
    }
}
?>
...
<head>
    <title>Kansas "Carry On My Wayward Son" (Supernatural) - Cello Cover </title>
	<meta name="description" content="Note e video di Carry On My Wayward di Kansa fatto per violoncello. Suonato e arrangiato da Veronika Krasteva. File pdf con le note scaricabile senza pagamento.">
    <meta charset="utf-8">
 ...
 <?php include 'menu.php';?>
    ...
    Language	  
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="kansas-carry-on-my-wayward-son-cello-cover.php?lingua=BG"> <span class="flag-icon flag-icon-bg"></span>Български</a>
		...
		<div class="header">
            <div class="row row2">
                <div class="col-md-12">
                    <h1>Kansas "Carry On My Wayward Son" (Supernatural) - Cello Cover </h1>
                </div>   
</div>				
            <div class="row row2">     			
			...
			<h4> Cover per violoncello della canzone Carry On My Wayward Son di Kansas. Diventata anche l'inno del Tv show Supernatural. Suonato e arrangiato da me. <h4>
			</div>
			</div>
			<div class="row row4">
