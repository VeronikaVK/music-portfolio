...
if($lingua!=''){
	if($lingua='BG'){
    header('location:apres-un-reve-gabriel-faure-violoncello-piano_bg.php');
	  exit;
    }
}
?>
...
<head>
    <title>Gabriel Fauré "Apres un Reve" - violoncello e piano</title>
	<meta name="description" content="Gabriel Fauré - Apres un Reve per violoncello e piano. Violoncellista - Veroika Krasteva. Comprende file pdf con le note scaricabile.">
    <meta charset="utf-8">
 ...
 <?php include 'menu.php';?>
    ...
    Language	  
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="apres-un-reve-gabriel-faure-violoncello-piano.php?lingua=BG"> <span class="flag-icon flag-icon-bg"></span>Български</a>
		...
		<div class="header">
            <div class="row row2">
                <div class="col-md-12">
                    <h1>Gabriel Fauré "Apres un Reve" per violoncello e piano</h1>
                </div>   
</div>				
            <div class="row row2">     			
			...
			<h4> Il famoso pezzo Apres un Reve dal compositore Gabriel Fauré. La parte del violoncello suonato da me. Con la colaborazione della pianista Andrea Eleonora Zappatore.<h4>
			</div>
			</div>
			<div class="row row4">
