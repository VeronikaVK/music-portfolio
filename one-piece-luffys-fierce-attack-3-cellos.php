...
if($lingua!=''){
	if($lingua='BG'){
    header('location:one-piece-luffys-fierce-attack-3-cellos_bg.php');
	  exit;
    }
}
?>
...
<head>
    <title>Cover di Luffy's Fierce Attack dal anime One Piece per tre violoncelli</title>
	<meta name="description" content="Note e video dal Luffy's Fierce Attack dal anime One Piece fatto per tre violoncelli. Suonato e arrangiato da Veronika Krasteva. File pdf con le note scaricabile senza pagamento.">
    <meta charset="utf-8">
 ...
 <?php include 'menu.php';?>
    ...
    Language	  
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="one-piece-luffys-fierce-attack-3-cellos.php?lingua=BG"> <span class="flag-icon flag-icon-bg"></span>Български</a>
		...
		<div class="header">
            <div class="row row2">
                <div class="col-md-12">
                    <h1>One Piece - Luffy's Fierce Attack (3 cellos)</h1>
                </div>   
</div>				
            <div class="row row2">     			
			...
			<h4> Il pezzo Luffy's Fierce Attack dal bellissimo <b>anime</b> One Piece fatto per tre violoncelli. Suonato e arrangiato da me. <h4>
			</div>
			</div>
			<div class="row row4">
