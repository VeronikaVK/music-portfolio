...
if($lingua!=''){
	if($lingua='BG'){
    header('location:one-piece-luffys-fierce-attack-cello-piano_bg.php');
	  exit;
    }
}
?>
...
<head>
    <title>Cover di Luffy's Fierce Attack dal anime One Piece per violoncello e piano</title>
	<meta name="description" content="Note e video dal Luffy's Fierce Attack dal anime One Piece fatto per violoncello e piano. Suonato e arrangiato da Veroika Krasteva. File pdf con le note scaricabile senza pagamento.">
    <meta charset="utf-8">
 ...
 <?php include 'menu.php';?>
    ...
    Language	  
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="one-piece-luffys-fierce-attack-cello-piano.php?lingua=BG"> <span class="flag-icon flag-icon-bg"></span>Български</a>
		...
		<div class="header">
            <div class="row row2">
                <div class="col-md-12">
                    <h1>"Luffy's Fierce Attack" One Piece - Cover per violoncello e piano</h1>
                </div>   
</div>				
            <div class="row row2">     			
			...
			<h4> Cover per violoncello e piano della canzone "Luffy's Fierce Attack" dal famoso anime One Piece per violoncello e piano. Suonata (la parte di violoncello) e arrangiata da me. Con la colaborazione della pianista Marta Grandi. <h4>
			</div>
			</div>
			<div class="row row4">
...
<div class="row">	
  ...
  <tbody>
    ...
    <tr>
      ...
      <td colspan="2">violoncello e piano</td>
    </tr>
	<tr>
