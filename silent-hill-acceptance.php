...
if($lingua!=''){
	if($lingua='BG'){
    header('location:silent-hill-acceptance_bg.php');
	  exit;
    }
}
?>
...
<head>
    <title>Silent Hill Shattered Memories "Acceptance" (voce e violoncello)</title>
	<meta name="description" content="Note e video della canzone Acceptance dal videogioco Silent Hill: Shattered Memories. Suonato e arrangiato da Veronika Krasteva. File pdf con le note scaricabile senza pagamento.">
    <meta charset="utf-8">
 ...
 <?php include 'menu.php';?>
    ...
    Language	  
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="silent-hill-acceptance.php?lingua=BG"> <span class="flag-icon flag-icon-bg"></span>Български</a>
		...
		<div class="header">
            <div class="row row2">
                <div class="col-md-12">
                    <h1>Silent Hill:Shattered Memories "Acceptance" - Violoncello e Voce</h1>
                </div>   
</div>				
            <div class="row row2">     			
			...
			<h4> Cover per voce e violoncello della canzone Acceptance dal videogioco Silent Hill: Shattered Memories. Suonata e arrangiata da me. <h4>
			</div>
			</div>
			<div class="row row4">
...
<div class="col-md-6 col-xs-12">	
  ...
  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/eIuL5gUvizk?rel=0" allowfullscreen></iframe>
</div>
</div>
<div class="col-md-6 col-xs-12">	
		<div class="embed-responsive embed-responsive-1by1">
  <iframe class="embed-responsive-item" src="https://www.veronikakrasteva.it/acceptance_cello_voice.pdf" allowfullscreen></iframe>
</div>
</div>
</div>
...
<div class="row">	
  ...
  <tbody>
	...
	<tr>
	<tr>
      <th scope="row">Compositore</th>
      <td>Akira Yamaoka</td>
    </tr>
	<tr>
      <th scope="row">Videogioco</th>
      <td colspan="2">Silent Hill:Shattered Memories</td>
    </tr>
    <tr>
      <th scope="row">Strumenti</th>
      <td colspan="2">voce e violoncello</td>
    </tr>
	<tr>
	...
	<tr>
      ...
      <td colspan="2">Avanzato</td>
    </tr>
	<tr>
      <th scope="row">Durata</th>
      <td colspan="2">03:58</td>
    </tr>
		<tr>
