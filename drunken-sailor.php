...
if($lingua!=''){
	if($lingua='BG'){
    header('location:drunken-sailor_bg.php');
	  exit;
    }
}
?>
...
<head>
    <title>Drunken Sailor – cover con voce e varie strumenti della musicoterapia </title>
	<meta name="description" content="La canzone popolare Drunken Sailor suonata e arrangiata da Veronika Krasteva. Una mostra delle strumenti musicali che uso per fare musicoterapia, compreso la proppria voce">
    <meta charset="utf-8">
 ...
 <?php include 'menu.php';?>
    ...
    Language	  
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="drunken-sailor.php?lingua=BG"> <span class="flag-icon flag-icon-bg"></span>Български</a>
		...
		<div class="header">
            <div class="row row2">
                <div class="col-md-12">
                    <h1>Drunken Sailor – cover con voce e varie strumenti della musicoterapia</h1>
                </div>   
</div>				
            <div class="row row2">     			
			...
			<h4> Cover della canzone popolare Drunken Sailor suonata e arrangiata da me. Con <b>varie strumenti musicali</b> che <b>uso nella mia pratica di musicoterapia</b>, compreso la proppria voce. <h4>
			</div>
			</div>
			<div class="row row4">
...
<div class="row">	
  ...
  <tbody>
    ...
    <tr>
      ...
      <td colspan="2">voce,violoncello,chitarra, daira, bar chimes, darbuka</td>
    </tr>
	<tr>
      <th scope="row">Livello</th>
      <td colspan="2">Base,  pensato per uso terapeutico durante incontri di musicoterapia</td>
    </tr>
	<tr>
      <th scope="row">Durata</th>
      <td colspan="2">01:10</td>
    </tr>
		<tr>
