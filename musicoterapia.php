...
if($lingua!=''){
	if($lingua='BG'){
    header('location:музикотерапия.php');
	  exit;
    }
}
?>
...
<head>
    <title>Incontri di musicoterapia a Verona e online </title>
    <meta charset="utf-8">
	<meta name="description" content="Incontri di musicoterapia per bambini, anziani, BES e adulti in provincia di Verona o in modalità online condotti dal musicoterapeuta Veronika Krasteva">
 ...
 <?php include 'menu.php';?>
    ...
    Language	  
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="musicoterapia.php?lingua=BG"> <span class="flag-icon flag-icon-bg"></span>Български</a>
        ...
        <div class="header">
            ...
            <div class="col-md-12 col-xs-12 text-center">
				<h3>COSA È LA MUSICOTERAPIA?</h3>
				<p><cite>La musicoterapia è l’uso professionale della musica e dei suoi elementi da parte di un musicoterapeuta qualificato con individui, gruppi, famiglie o comunità che desiderano migliorare la propria qualità di vita e la propria condizione fisica, sociale, comunicativa, emotiva, intellettiva e spirituale</cite> <br>(World Federation of Music Therapy, 2011)
				</p>
		        ...
		        <div class="row">
            <div class="col-md-12 col-xs-12 text-center">
                <h3>A CHI È RIVOLTO IL SERVIZIO DI MUSICOTERAPIA?</h3>
            </div>
		 ...
		 <div class="row">
			...
			<p>Utilizzo diretto degli strumenti musicali attraverso l’improvvisazione sonoro-musicale, all’interno di un setting strutturato, utile a favorire la libera espressione della persona anche in presenza di gravi deficit cognitivi e assenza di linguaggio.
			</p>
			</div>
		<div class="col-md-4 col-xs-12">
		<i class="fc fa-calendar" aria-hidden="true">Durata: min. 5 incontri</i>
		</div>
		<div class="col-md-4 col-xs-12">
		<i class="fc fa-clock-o" aria-hidden="true">Durata incontro: 1 ora</i>
		</div>
		<div class="col-md-4 col-xs-12">
		<i class="fc fa-check" aria-hidden="true">Tipologie consulenze: bambini/anziani/BES/adulti</i>
		</div>
		
				
				
				<div class="col-md-12 col-xs-12 text-center">
                    <a href="contattami.php" class="btn btn-outline-danger ">Contattami per maggiori informazioni</a>
                </div>
		</div>
