...
if($lingua!=''){
	if($lingua='BG'){
    header('location:la-casa-de-papel-my-life-is-going-on-3-cellos_bg.php');
	  exit;
    }
}
?>
...
<head>
    <title>La casa di carta - My life is going on per Violoncello (COVER) </title>
	<meta name="description" content="Note e video della canzone My life is going on (La Casa De Papel/La casa di carta) cantata da Celia Krull. Suonato e arrangiato da Veronika Krasteva. File pdf con le note scaricabile senza pagamento.">
    <meta charset="utf-8">
 ...
 <?php include 'menu.php';?>
    ...
    Language	  
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="la-casa-de-papel-my-life-is-going-on-3-cellos.php?lingua=BG"> <span class="flag-icon flag-icon-bg"></span>Български</a>
		...
		<div class="header">
            <div class="row row2">
                <div class="col-md-12">
                    <h1>Cecilia Krull "My Life Is Going On" (La Casa di Carta ) - 3 Cellos</h1>
                </div>   
</div>				
            <div class="row row2">     			
			...
			<h4> Cover per 3 violoncelli dalla canzone "My Life Is Going On" della popolare serie tv spagnola <b>La Casa di Carta</b>. Suonata e arrangiata da me. <h4>
			</div>
			</div>
			<div class="row row4">
...
<div class="row">	
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">Cantante</th>
      <td>Cecilia Krull </td>
    </tr>
	<tr>
      <th scope="row">Serie TV</th>
      <td colspan="2">La Casa di Carta (La Casa De Papel)</td>
    </tr>
    <tr>
      <th scope="row">Strumenti</th>
      <td colspan="2">3 violoncelli</td>
    </tr>
	<tr>
