...
if($lingua!=''){
	if($lingua='IT'){
    header('location:dunavsko-horo-cello.php');
	  exit;
    }
}
?>
...
<head>
    <title>Дунавско Хоро за Виолончело</title>
    <meta charset="utf-8">
	<meta name="description" content="Ноти и видео на Дунавското хоро за виолончело. Изпълнение и аранжимент от Вероника Кръстева. Pdf файл с нотите за безплатно теглене.">
 ...
 <?php include 'menu_bg.php';?>
    ...
    Language	  
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="dunavsko-horo-cello_bg.php?lingua=IT"><span class="flag-icon flag-icon-it"> </span>Italiano</a>
                </div>
				</li>
                </ul>
            </div>
        ...
        <div class="header">
            <div class="row row2">
                <div class="col-md-12">
                    <h1>Дунавско Хоро за Виолончело</h1>					
                </div>   
</div>				
            <div class="row row2">     			
			...
			<h4> Дунавското хоро изсвирено на виолончело. Изпълнение и аранжимент от мен. <h4>
			</div>
			</div>
			<div class="row row4">
...
<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/1SgoPlxumI4?rel=0" allowfullscreen></iframe>
</div>
</div>
<div class="col-md-6 col-xs-12">	
		<div class="embed-responsive embed-responsive-1by1">
   <iframe class="embed-responsive-item" src="https://www.veronikakrasteva.it/dunavsko_horo.pdf" allowfullscreen></iframe>
</div>
</div>
</div>
