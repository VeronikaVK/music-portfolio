...
if($lingua!=''){
	if($lingua='BG'){
    header('location:ilia-draganov-elegia-cello-piano_bg.php');
	  exit;
    }
}
?>
...
<head>
    <title>"Elegy" di Ilia Draganov per violoncello e piano</title>
	<meta name="description" content="Note e video del pezzo Elegy dal compositore bulgaro Ilia Draganov. Violoncellista - Veronika Krasteva. File pdf con le note scaricabile senza pagamento.">
    <meta charset="utf-8">
 ...
 <?php include 'menu.php';?>
    ...
    Language	  
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="ilia-draganov-elegia-cello-piano.php?lingua=BG"> <span class="flag-icon flag-icon-bg"></span>Български</a>
		...
		<div class="header">
            <div class="row row2">
                <div class="col-md-12">
                    <h1>"Elegy" di Ilia Draganov per violoncello e piano</h1>
                </div>   
</div>				
            <div class="row row2">     			
			...
			<h4> Il pezzo Elegy dal compositore bulgaro Ilia Draganov. La parte del violoncello suonata da me. Con la colaborazione della pianista Marta Espejo.<h4>
			</div>
			</div>
			<div class="row row4">
