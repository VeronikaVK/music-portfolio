...
if($lingua!=''){
	if($lingua='IT'){
    header('location:musicoterapia.php');
	  exit;
    }
}
?>
...
<head>
    <title>Сесии по музикотерапия</title>
    <meta charset="utf-8">
	<meta name="description" content="Сесии по музикотерапия за деца със специални образователни потребности и възрастни с деменция, провеждани от музикотерапевта Вероника Кръстева.">
 ...
 <?php include 'menu_bg.php';?>
    ...
    Language	  
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="музикотерапия.php?lingua=IT"><span class="flag-icon flag-icon-it"> </span>Italiano</a>
                </div>
				</li>
                </ul>
            </div>
        ...
        <div class="header">
            ...
            <div class="col-md-12 col-xs-12 text-center">
				...
				<h3>Какво е музикотерапия?</h3>
				<p><cite>Музикотерапията е професионалното използване на музиката и нейните елементи от квалифициран музикален терапевт с лица, групи, семейства или общности, които желаят да подобрят качеството си на живот и своето физическо, социално, комуникативно, емоционално, интелектуално и духовно състояние.</cite> <br>(World Federation of Music Therapy, 2011)
				</p>
		 ...
		 <div class="row">
			...
			<p>Директно използване на музикални инструменти чрез звуково-музикална импровизация, в рамките на структурирана обстановка, полезна за насърчаване на свободното изразяване на човека дори при наличие на тежки когнитивни дефицити.
			</p>
			</div>
		<div class="col-md-4 col-xs-12">
		<i class="fc fa-calendar" aria-hidden="true">Продължителност: мин. 5 срещи</i>
		</div>
		<div class="col-md-4 col-xs-12">
		<i class="fc fa-clock-o" aria-hidden="true">Продължителност една среща: 1 час</i>
		</div>
		<div class="col-md-4 col-xs-12">
		<i class="fc fa-check" aria-hidden="true">Видове консултации: <br>деца / възрастни / СОП</i>
		</div>
